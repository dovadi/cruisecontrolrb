...
ActionMailer::Base.server_settings = {
  :address => "127.0.0.1",
  :port => 25,
  #It is nessary to specify domain!!!
  :domain => "cc.dovadi.com"
}
...
Configuration.default_polling_interval = 5.minute
...
Configuration.email_from = 'cc@cc.dovadi.com'
...
Configuration.dashboard_url = 'http://cc.dovadi.com/'
